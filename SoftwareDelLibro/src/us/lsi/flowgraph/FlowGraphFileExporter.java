...
public class FlowGraphFileExporter {
	 ...
	 * @param conNombres Si queremos que aparezcan los nombres devuelto por toString()
	 * @param min Si queremos minimizar la función objetivo
	 * @return El grafo de flujo construido
	 */
	public static FlowGraph solveProblemFlow(
			String fileIn, String fileGraphFlow, String fileSolutionsGraphFlow,
		...
		FlowGraphFileExporter.saveFileFlow(fg, fileGraphFlow, conNombres);
		FlowGraphFileExporter.saveFileFlowSoutions(fg, fileSolutionsGraphFlow,
				sourceFlow, sinkFlow, edgeFlow, conNombres);
		String s = p.toStringConstraints()+fa.toStringIndex();
		StringExtensions2.toFile(s, fileConstraints);
		return fg;
	}
	...
	public static void saveFileFlow(FlowGraph graph, String file,
		...
		GraphsFileExporter.saveFile((Graph<FlowVertex, FlowEdge>) graph, file,
				new StringNameProvider<FlowVertex>(), null, null,
