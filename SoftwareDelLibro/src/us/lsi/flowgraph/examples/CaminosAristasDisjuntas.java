...
public class CaminosAristasDisjuntas {
	...
	public static void creaFichero(String fileIn, String fileOut, Ciudad from, Ciudad to){
		...
		for(Ciudad c:gs.vertexSet()){
			if (c.equals(from)) {
				...
				f.println(c + ",0,0.0,inf,0.0"); //No hay limitaciones para que pasen caminos
				                                 //por cada vértice
			}
		}		
		f.println("#EDGE#");
	...
	public static void main(String[] args) {
		...
		FlowGraphSolution fs = SolveFlowGraphProblem.solve(
				"./ficheros/andaluciaFlow2.txt", 
				"./ficheros/andaluciaFlowGrafo2.gv", 
				"./ficheros/andaluciaFlowSoluciones2.gv",
				"./ficheros/andaluciaFlowConstraints2.txt",
				true,
				false);
		...
		System.out.println("=========="+fs.getWalks(true));
	}
}
