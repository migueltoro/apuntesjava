 ...
 * 
 * 
 * <p> Se dan conjunto de <code> n </code> objetos distintos y unas multiplicidades máximas para cada uno de ellos.
 * A partir de esa información se construye la secuencia normal que asumimos
 * de tamaño <code> r </code>. </p>
 *  
...
public interface ProblemaAGIndex<S> extends ProblemaAG {	
    ...
    /**
     * @return La secuencia normal asociada al problema. Siendo <code> n </code> el número de objeto la secuencia normal está formado por la concatenación de  
