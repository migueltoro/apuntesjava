...
public class Semiplano2D extends Recta2D implements ObjetoGeometrico2D {
	...
	public void draw(Graphics2D g) {
		...
		Poligono2D r = intersecta(Poligono2D.createRectangulo(
				(double)MarcoDeTrabajo.xMin,(double)MarcoDeTrabajo.xMax,
				(double)MarcoDeTrabajo.yMin,(double)MarcoDeTrabajo.yMax));
		MarcoDeTrabajo.fill(g, r);
	}
